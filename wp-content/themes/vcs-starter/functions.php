...
add_image_size ('logo',190, 50, false);

add_image_size ('gallery',1536, 1536, false);
...
function theme_scripts(){
    ...
    if ( !is_admin() ) {
        ...
        wp_register_script(
		'fontawesome', 
		'https://kit.fontawesome.com/1af26b4a6f.js', 
		array('jquery'), 
		false, 
		true);
...
function theme_stylesheets(){
	...
	if( defined('THEME_FOLDER') ) {
		...
		wp_register_style(
		'projektas', 
		THEME_FOLDER . '/assets/css/projektas.css', 
		array(), 
		false, 
		'all');

		//Loading
		wp_enqueue_style('projektas');
	}
}
